class Suite {
  async selectSuite(projectId, fileName, api, consoleApp, customNames, path) {
    ...
    do {
      ...
      // If Create new suite is selected, it first checks if the suite exists - if it does, it asks for the suite selection again (the do-while loop and repeat variable)
